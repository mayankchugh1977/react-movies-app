                    ...
                    <div className="right">
                        <Card>
                            <CardContent>
                                ...
                                <FormControl className={classes.formControl} > 
                                    <InputLabel htmlFor="movieHeader"> Movie Name </InputLabel>
                                ...
                                <FormControl className={classes.formControl} > 
                                    ...
                                    <Select 
                                        multiple 
                                        imput={<Input id="select-multiple-checkbox-genre" />}
                                ...
                                <FormControl className={classes.formControl} > 
                                    <InputLabel htmlFor="select-multiple-checkbox-artist"> Artist </InputLabel>
                                    <Select 
                                        multiple 
                                        imput={<Input id="select-multiple-checkbox-artist" />}
                                        renderValue={selected => selected.join(',')}
                                ...
                                <FormControl className={classes.formControl} > 
                                    <Button variant="contained" color="primary" onClick={this.applyClickedHandler}> 
                                        Apply 
                                    </Button>
                                </FormControl>
